...
function getDefaultAnimationPresets(): AnimationPreset[] {
  return [
    ...
    },
    {
      ...
      category: 'Motion',
      preset_type: { type: 'Float', amplitude: 5, speed: 1.0 },
    },
    {
      id: 'steam',
      name: 'Steam',
      description: 'Rising steam effect',
      category: 'Effects',
      preset_type: { type: 'Float', amplitude: 15, speed: 0.8 },
    },
    {
      id: 'gentle-sway',
      name: 'Gentle Sway',
      description: 'Very subtle swaying',
      category: 'Motion',
      preset_type: { type: 'Float', amplitude: 3, speed: 0.7 },
    },
    {
      id: 'fly-across',
      name: 'Fly Across',
      description: 'Fly across the scene',
      category: 'Motion',
      preset_type: { type: 'Slide', direction: 'Left', speed: 0.5 },
    },
    {
      id: 'twinkle',
      name: 'Twinkle',
      ...
      category: 'Effects',
      preset_type: { type: 'Glow', intensity: 0.3, color: [255, 255, 200] },
    },
    {
      id: 'stars-twinkle',
      name: 'Stars Twinkle',
      description: 'Stars twinkling effect',
      category: 'Effects',
      preset_type: { type: 'Glow', intensity: 0.4, color: [200, 200, 255] },
    },
    {
      id: 'rain-fall',
      name: 'Rain Fall',
      ...
      category: 'Effects',
      preset_type: { type: 'Rain', density: 150, angle: 80, speed: 600 },
    },
    {
      id: 'firefly-float',
      name: 'Firefly Float',
      description: 'Floating fireflies',
      category: 'Effects',
      preset_type: { type: 'Float', amplitude: 20, speed: 0.5 },
    },
    {
      id: 'drift',
      name: 'Drift',
      ...
      category: 'Motion',
      preset_type: { type: 'Float', amplitude: 8, speed: 0.3 },
    },
    {
      id: 'pulse',
      name: 'Pulse',
      ...
      category: 'Effects',
      preset_type: { type: 'Breathing', amplitude: 0.1, speed: 1.5 },
    },
    {
      id: 'subtle-movement',
      ...
      category: 'Motion',
      preset_type: { type: 'Float', amplitude: 4, speed: 0.5 },
    },
    {
      id: 'rotate-slow',
      name: 'Rotate Slow',
      ...
      category: 'Motion',
      preset_type: { type: 'Rotate', speed: 10, clockwise: true },
    },
  ]
}
